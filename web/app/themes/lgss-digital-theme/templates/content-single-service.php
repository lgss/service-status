<?php while (have_posts()) : the_post() ?>
  <article <?php post_class('clearfix') ?>>
    ...
    <header>
      ...
      <?php get_template_part('templates/service-meta') ?>
    </header>
    <div class="entry-content">
      <p><strong>Status</strong>: <?php echo get_field('ccc_status'); ?><br/>
      <strong>Uptime</strong>: <?php echo get_field('ccc_percentage'); ?>%</p>
      
      <?php if(get_field('ccc_reason')) { ?>
      <h4>Latest Update</h4>
      <p><?php echo get_field('ccc_reason'); ?></p>
      <?php } ?>
